    ...
    return (
        ...
        >
            ...
            <div className="h-16 flex items-center px-6 mb-4">
                ...
                {isExpanded && (
                    <span className="ml-4 font-black text-slate-900 tracking-tight transition-opacity duration-300">
            MENU
          </span>
                )}
            </div>

            {/* Perfil / Empresa (Solo se ve bien si está expandido) */}
            <div className={cn(
                "flex flex-col items-center mb-8 px-4 transition-all",
            ...
            <div className="flex-1 overflow-y-auto px-3 space-y-2 custom-scrollbar overflow-x-hidden">
                {menuSections.map((section) => (
                    <SidebarGroup key={section.title} section={section} isExpanded={isExpanded} />
                ))}
            ...
            {/* Footer Mini */}
            <div className="p-4 bg-slate-50/50 border-t border-slate-50 flex justify-center text-[10px] font-bold text-slate-400">
