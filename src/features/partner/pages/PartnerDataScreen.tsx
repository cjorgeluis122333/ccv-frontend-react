        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden hover:border-fuchsia-200 hover:shadow-md transition-all duration-300 group">
            ...
            <div className="p-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-5 gap-y-4">
                    ...
                    <FamilyInputField label="Teléfono" field="telefono" value={formData.telefono} onChange={handleInputChange} icon="call" />
                    <FamilyInputField label="Correo Electrónico" field="correo" value={formData.correo} onChange={handleInputChange} icon="mail" type="email" />
                    ...
                    <FamilyInputField label="Ingreso" field="ingreso" value={formData.ingreso} onChange={handleInputChange} icon="calendar_month" type="date" />
                    <FamilyInputField label="Ocupación" field="ocupacion" value={formData.ocupacion} onChange={handleInputChange} icon="work" />
                    {/* Al igual que el titular, la "categoría" de los familiares se puede ocultar si así se desea, aquí la omitimos. */}
                </div>
            </div>
        </div>
    );
