                ...
                return (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3 relative z-20">
                            ...
                            <div>
                                <h4 className="font-bold text-slate-800 text-sm">{debt.mes}</h4>
                                <span className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider">{debt.estado}</span>
                            </div>
                        </div>
